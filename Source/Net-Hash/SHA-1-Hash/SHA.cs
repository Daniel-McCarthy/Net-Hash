    ...
    public class SHA
    {
        ...
        public static string sha2_224Hash(byte[] message)
        {

            {
                ...
                uint calculation4(uint v1)
                {
                    return (rotateRight(v1, 6) ^ rotateRight(v1, 11) ^ rotateRight(v1, 25));
                }

                uint calculation5(uint v1)
                {
                    return (rotateRight(v1, 7) ^ rotateRight(v1, 18) ^ (v1 >> 3));
                }

                uint calculation6(uint v1)
                {
                    return (rotateRight(v1, 17) ^ rotateRight(v1, 19) ^ (v1 >> 10));
                }
